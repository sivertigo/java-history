...
/**
* com/sun/corba/se/ActivationIDL/_LocatorImplBase.java .
...
public abstract class _LocatorImplBase extends org.omg.CORBA.portable.ObjectImpl
                implements com.sun.corba.se.ActivationIDL.Locator, org.omg.CORBA.portable.InvokeHandler
{
  ...
  // Starts the server if it is not already running.
       case 0:  // ActivationIDL/Locator/locateServer
       {
         try {
  ...
  // Starts the server if it is not already running.
       case 1:  // ActivationIDL/Locator/locateServerForORB
       {
         try {
           int serverId = com.sun.corba.se.ActivationIDL.ServerIdHelper.read (in);
  ...
  // get the port for the endpoint of the locator
       case 2:  // ActivationIDL/Locator/getEndpoint
       {
         try {
  ...
  // to pick a particular port type.
       case 3:  // ActivationIDL/Locator/getServerPortForType
       {
         try {
