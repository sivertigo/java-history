...
public class Hashtable extends Dictionary implements Map, Cloneable,
	...
	public boolean hasMoreElements() {
	    ...
	    int i = index;
	    Entry t[] = table;
	    while (e==null && i>0) /* Hot spot in specs, use locals */
		e = t[--i]; /* Could remove array bounds check */
	    entry = e;
	    index = i;
	    return entry != null;
	}
	...
	public Object nextElement() {
	    ...
	    int i = index;
	    Entry t[] = table;
	    while (e1==null && i>0) /* Hot spot in specs, use locals */
		e1 = t[--i]; /* Could remove array bounds check */
	    entry = e1;
	    index = i;
	    if (entry != null) {
