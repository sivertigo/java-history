/*
 * @(#)DateFormatZoneData_en_US.java	1.3 01/11/29
 *
 ...
 *
 * Portions copyright (c) 1997, 1998, 2000 Sun Microsystems, Inc.
 * All Rights Reserved.
 *
        ...
        return new Object[][] {
            {"zoneStrings",
                new String[][] {
                    ...
                    {"Europe/Lisbon", "West European Time", "WET",
                    ...
                    {"Asia/Jerusalem", "Israel Standard Time", "IST",
                     "Israel Daylight Time", "IDT" /*Tel Aviv*/},
                    {"Asia/Tehran", "Iran Standard Time", "IRT",
